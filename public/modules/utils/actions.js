...
export const VACANCY_SET_RATE = 'vacancy-set-rate';
export const VACANCY_GET_RATE = 'vacancy-get-rate';
export const VACANCY_DELETE_RATE = 'vacancy-delete-rate';
export const VACANCY_CHANGE_RATE = 'vacancy-change-rate';
export const VACANCY_SET_EXECUTOR = 'vacancy-set-executor';
